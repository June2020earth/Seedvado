 ...
 * @author acer
 */
@WebServlet(name = "EditOrderCompleteServlet", urlPatterns = {"/EditOrderCompleteServlet"})
public class EditOrderCompleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet rs = statement.executeQuery();   
                ...
                query="UPDATE CusOrder SET COMPLETE=True WHERE OrderID=?";
                ...
                context.log(st.toString());        
                int unknown = st.executeUpdate();
                context.log(String.valueOf(unknown));  
                
   ArrayList Rows = new ArrayList();

        context.log("outside loop");
   while (rs.next()){
